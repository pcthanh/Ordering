...
export class Gof3rHomeComponent implements OnInit {
    ...
    list: any[] = [];
    // mapLoaction=[
    //     {Name:"JURONG WEST",Enbale:"N",h:"<h1>thanh</h1>",map:'<path fill="#712FDB"  stroke="#FFFFFF" stroke-width="2" stroke-miterlimit="10" d="M255.385,287.839c0,0,0.702-6.082-8.187-5.38'+
    ...
    //                             '/>'+
    //                             '<text transform="matrix(1 0 0 1 133.2906 391.4559)" fill="#FFFFFF" font-family="Roboto" font-size="12.6304">JURONG </text>'+
